    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <motion.p
          ...
          className="text-lg text-orange-300 my-5 max-w-[600px]"
        >
        
          I&apos;Cybersecurity Specialist and Software Developer with a proven track record in Bug Bounty Hunting and Penetration Testing. 
